...
extension PlayModeExtension on PlayMode {
  ...
  String get description {
    switch (this) {
      ...
      case PlayMode.oceanAquarium:
        return 'Create your own relaxing underwater aquarium';
      case PlayMode.starryNight:
        return 'Tap to create stars and draw constellations';
      case PlayMode.colorBloom:
        return 'Watch beautiful colors bloom like ink in water';
      case PlayMode.floatingLantern:
        return 'Release lanterns with wishes into the night sky';
    }
  }
