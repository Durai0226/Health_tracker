...
import 'floating_lantern_game.dart';
          ...
          children: [
            GestureDetector(
              ...
              child: GlassmorphicContainer(
                ...
                child: Icon(Symbols.close_rounded, color: theme.textColor, size: 22),
              ),
            ),
  ...
  Widget _buildPlayScreen() {
    switch (widget.mode) {
      ...
      case PlayMode.oceanAquarium:
        return const OceanAquariumGame();
      case PlayMode.starryNight:
        return const StarryNightGame();
      case PlayMode.colorBloom:
        return const ColorBloomGame();
      case PlayMode.floatingLantern:
        return const FloatingLanternGame();
    }
  }
}
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Symbols.close_rounded, color: theme.backgroundColor, size: 22),
                      ),
                    ),
                    const SizedBox(width: 16),
                    Text(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Symbols.refresh_rounded, color: theme.backgroundColor, size: 22),
                      ),
                    ),
                  ],
                ),
